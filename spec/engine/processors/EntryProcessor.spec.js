...
const ImageBlobFormatter = require('../../../src/engine/processors/entryFormatter/ImageBlobFormatter.js').ImageBlobFormatter;

const EntryProcessor = require('../../../src/engine/processors/EntryProcessor.js').EntryProcessor;
